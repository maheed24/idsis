...
<!-- ADD NEW PROVINCE -->
<div class="modal fade" id="mdlAddProvince" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog" style="width:80%!important;">
		<div class="modal-content">
			<div class="modal-header" style="background:#367fa9;color:white;font-family:calibri;font-size:16px;">
				...
				<h4 class="modal-title" style="font-family:calibri;font-size:16px;"><b>CREATE NEW PROVINCE</b></h4>
          	</div>
          	<div class="modal-body" style="font-family:calibri;font-size:14px;font-weight:normal;padding-bottom:0px;">
				<form id="AddFormShipClassifications" action="{{url('Province')}}" class="form-horizontal" method="POST"  style="margin-top:10px;!important">
                    {!! csrf_field() !!}
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group" style="padding-left:20px!important;padding-right:20px!important;">
								...
								<input type="text" class="form-control clear" name="province_desc" id="addtxtprovincedesc" style="width:100%!important;" required />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group" style="padding-left:20px!important;padding-right:20px!important;">
								<label>MRO</label>
								<select class="form-control select2" name="office_id" id="addddlofficeidprovince" style="width:100%;">
									<option value="" selected="selected" disabled>PLEASE SELECT REGIONAL OFFICE</option>
...
<div class="modal fade" id="editmodal" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog" style="width:80%!important;">
		<div class="modal-content">
			<div class="modal-header" style="background:#367fa9;color:white;font-family:calibri;font-size:16px;">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" style="font-family:calibri;font-size:16px;"><b>UPDATE PROVINCE</b></h4>
          	</div>
          	<div class="modal-body" style="font-family:calibri;font-size:14px;font-weight:normal;padding-bottom:0px;">
				<form id="editForm" action="/Province" class="form-horizontal" method="POST"  style="margin-top:10px;!important">
                    {!! csrf_field() !!}
                    @method("PATCH")
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group" style="padding-left:20px!important;padding-right:20px!important;">
								<label>Province</label>
								<input type="text" class="form-control clear" name="province_desc" id="province_desc" style="width:100%!important;" required />
