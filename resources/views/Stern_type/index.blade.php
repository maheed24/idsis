...
<body class="hold-transition skin-blue fixed sidebar-mini">
	...
	<div class="wrapper">
			...
			<section class="content">
				...
				<div class="box" style="display:none;">
					<div class="box-header with-border">
						<h4><b>LIST OF STERN TYPE</b></h4>
						<div class="box-tools pull-right">
							<a href="#mdlAddSternType" data-toggle="modal" class="btn btn-primary btn-sm btn-flat clear_txt" style="margin-top:8px!important;"> NEW STERN TYPE</a>
						</div>
					</div>
					<div class="box-body">
						<div id="container_cert_type">
							<table id="tblSternType" class="table table-striped table-bordered" >
								<thead style="font-family:calibri;font-size:15px;">
									...
									<th style="background:#367fa9;color:white;width:68%;">STERN TYPE</th>
								...
								<tbody style="font-family:calibri;font-size:15px;">
                                    ...
                                    <tr>
										...
										<td style="width:68%;">{{$item->stern_type_desc}}</td>
		...
		<!-- /.content-wrapper -->
         ...
         @include('Stern_type.modal.modal')
...
<script>
  ...
  $(document).on('click','.editbtn',function(){
	$('#editmodal').modal('show');
            ...
            $('#id').val(data[0]);
            $('#stern_type_desc').val(data[1]);
            $('#editForm').attr('action','/Stern_type/'+data[0]);
        $('#editmodal').modal('show');
