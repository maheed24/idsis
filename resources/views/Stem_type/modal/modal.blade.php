<style>
 ...
 <!-- ADD NEW STEM TYPE -->
<div class="modal fade" id="mdlAddStemType" data-backdrop="static" data-keyboard="false">
		...
		<div class="modal-content">
			<div class="modal-header" style="background:#367fa9;color:white;font-family:calibri;font-size:16px;">
          	...
          	<div class="modal-body" style="font-family:calibri;font-size:14px;font-weight:normal;padding-bottom:0px;">
				<form action="{{url('Stem_type')}}" class="form-horizontal" method="POST"  style="margin-top:10px;!important">
                    {!! csrf_field() !!}
					...
					<div class="row">
						<div class="row">
							...
							<div class="form-group" style="padding-left:20px!important;padding-right:20px!important;">
								...
								<input type="text" class="form-control clear" name="stem_type_desc" id="addtxtstemtypedesc" style="width:100%!important;" required />
							</div>
						</div>
					</div>
                        <div class="hidden">
				...
				<form id="editForm" action="/Stem_type" class="form-horizontal" method="POST"  style="margin-top:10px;!important">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group" style="padding-left:20px!important;padding-right:20px!important;">
								<label>Stem Type</label>
								<input type="text" class="form-control clear" name="stem_type_desc" id="stem_type_desc" style="width:100%!important;" required />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group" style="padding-left:20px!important;padding-right:20px!important;">
