			...
			<section class="content">
				...
				<div class="box" style="display:none;">
					<div class="box-header with-border">
						<h4><b>LIST OF STEM TYPE</b></h4>
						<div class="box-tools pull-right">
							<a href="#mdlAddStemType" data-toggle="modal" class="btn btn-primary btn-sm btn-flat clear_txt" style="margin-top:8px!important;"> NEW STEM TYPE</a>
						</div>
					</div>
					<div class="box-body">
						<div id="container_cert_type">
							<table id="tblStemType" class="table table-striped table-bordered" >
								<thead style="font-family:calibri;font-size:15px;">
									...
									<th style="background:#367fa9;color:white;width:68%;">STEM</th>
								...
								<tbody style="font-family:calibri;font-size:15px;">
                                    ...
                                    <tr>
										...
										<td style="width:68%;">{{$item->stem_type_desc}}</td>
...
<script>
  ...
  $(document).on('click','.editbtn',function(){
	$('#editmodal').modal('show');
            ...
            $('#editForm').attr('action','/Stem_type/'+data[0]);
        $('#editmodal').modal('show');
