			...
			<section class="content">
				...
				<div class="box" style="display:none;">
					<div class="box-header with-border">
						<h4><b>LIST OF RIG TYPE</b></h4>
						<div class="box-tools pull-right">
							<a href="#mdlAddRigType" data-toggle="modal" class="btn btn-primary btn-sm btn-flat clear_txt" style="margin-top:8px!important;"> NEW RIG TYPE</a>
						</div>
					</div>
					<div class="box-body">
						<div id="container_ship_type">
							<table id="tblRigType" class="table table-striped table-bordered" >
								<thead style="font-family:calibri;font-size:15px;">
									<th style="background:#367fa9;color:white;width:10%;">ID</th>
									<th style="background:#367fa9;color:white;width:68%;">RIG TYPE</th>
								...
								<tbody style="font-family:calibri;font-size:15px;">
                                    ...
                                    <tr>
									    ...
									    <td style="width:68%;">{{$item->rig_type_desc}}</td>
...
<script>
  ...
  $(document).on('click','.editbtn',function(){
	$('#editmodal').modal('show');
            ...
            $('#id').val(data[0]);
            $('#rig_type_desc').val(data[1]);
            $('#editForm').attr('action','/Rig_type/'+data[0]);
        $('#editmodal').modal('show');
