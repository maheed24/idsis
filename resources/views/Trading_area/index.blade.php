...
<body class="hold-transition skin-blue fixed sidebar-mini">
	...
	<div class="wrapper">
			...
			<section class="content">
				...
				<div class="box" style="display:none;">
					<div class="box-header with-border">
						<h4><b>LIST OF TRADING AREA</b></h4>
						<div class="box-tools pull-right">
							<a href="#mdlAddTradingArea" data-toggle="modal" class="btn btn-primary btn-sm btn-flat clear_txt" style="margin-top:8px!important;"> NEW TRADING AREA</a>
						</div>
					</div>
					<div class="box-body">
						<div id="container_cert_type">
							<table id="tblSternType" class="table table-striped table-bordered" >
								<thead style="font-family:calibri;font-size:15px;">
									<th style="background:#367fa9;color:white;width:10%;">ID</th>
									<th style="background:#367fa9;color:white;width:68%;">TRADING AREA</th>
								...
								<tbody style="font-family:calibri;font-size:15px;">
                                    ...
                                    <tr>
										...
										<td style="width:68%;">{{$item->trading_areas_desc}}</td>
		...
		<!-- /.content-wrapper -->
         ...
         @include('Trading_area.modal.modal')
...
<script>
  ...
  $(document).on('click','.editbtn',function(){
	$('#editmodal').modal('show');
            ...
            $('#id').val(data[0]);
            $('#trading_area_desc').val(data[1]);
            $('#editForm').attr('action','/Trading_area/'+data[0]);
        $('#editmodal').modal('show');
...
<script>
	$('#tblSternType').DataTable({
		responsive: true,
		"bLengthChange": false,
		"iDisplayLength": 10,
		"language": {
		  "emptyTable": "THERE IS NO AVAILABLE DATA FOR STEM IN THE DATABASE"
		},
		"columnDefs": [
			{
				"targets": [ 0 ],
