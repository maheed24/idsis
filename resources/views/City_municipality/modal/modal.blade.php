...
<div class="modal fade" id="mdlAddCityMunicipality" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog" style="width:80%!important;">
		<div class="modal-content">
			<div class="modal-header" style="background:#367fa9;color:white;font-family:calibri;font-size:16px;">
				...
				<h4 class="modal-title" style="font-family:calibri;font-size:16px;"><b>CREATE NEW CITY/MUNICIPALITY</b></h4>
          	</div>
          	<div class="modal-body" style="font-family:calibri;font-size:14px;font-weight:normal;padding-bottom:0px;">
				<form id="AddFormShipClassifications" action="{{url('City_municipality')}}" class="form-horizontal" method="POST"  style="margin-top:10px;!important">
                    {!! csrf_field() !!}
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group" style="padding-left:20px!important;padding-right:20px!important;">
								...
								<input type="text" class="form-control clear" name="city_municipality_desc" id="addtxtcitymunicipalitydesc" style="width:100%!important;" required />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group" style="padding-left:20px!important;padding-right:20px!important;">
								<label>Province</label>
								<select class="form-control select2" name="province_id" id="addddlprovinceidcitymunicipality" style="width:100%;">
									<option value="" selected="selected" disabled>PLEASE SELECT PROVINCE</option>
									@foreach($Province as $item)
                                    <option value="{{$item->id}}">{{$item->province_desc}}</option>
                                   @endforeach						
								</select>
							</div>
						</div>
...
<div class="modal fade" id="editmodal" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog" style="width:80%!important;">
		<div class="modal-content">
			<div class="modal-header" style="background:#367fa9;color:white;font-family:calibri;font-size:16px;">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" style="font-family:calibri;font-size:16px;"><b>UPDATE CITY/MUNICIPALITY</b></h4>
          	</div>
          	<div class="modal-body" style="font-family:calibri;font-size:14px;font-weight:normal;padding-bottom:0px;">
				<form id="editForm" action="/City_municipality" class="form-horizontal" method="POST"  style="margin-top:10px;!important">
                    {!! csrf_field() !!}
                    @method("PATCH")
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group" style="padding-left:20px!important;padding-right:20px!important;">
								<label>City/Municipality</label>
								<input type="text" class="form-control clear" name="city_municipality_desc" id="city_municipality_desc" style="width:100%!important;" required />
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group" style="padding-left:20px!important;padding-right:20px!important;">
