...
<body>
    ...
    <p class="p2" style='text-align: justify'>
        ...
        pursuant to the provisions of Section 38, Article 13 of Republic Act 11054 and its
        impelementing Rules and Regulation, having taken and subscribed to the Oath required bt law and having sworn
        that:
    </p>
    <br>
    <table class="tables">
    ...
    <p class="p2" style='text-align: center'>
        ...
        BARMM Government of the Philippines, under my hand and seal at Cotabato City this <b> {{ $date_issue }}.</b>
    </p>
    <p class="p2" style='text-align: left'>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This permit will remain in
        force until <b>{{ $valid_date }}</b>.
    </p>
    <br><br><br>
    <br><br><br>
