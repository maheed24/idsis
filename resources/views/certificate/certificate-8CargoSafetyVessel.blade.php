...
<body>
    ...
    <table>
        ...
        <tr>
            <td style="width:25%;">Owner/operator: <br><br>
            ...
            <td style="width:25%;">Class/Type: <br><br>
                <center><b class="value">{{ $operation[0]->operation_desc }}</b></center>
            </td>

        </tr>
        <tr>
            <td style="width:25%;">Trading place: <br><br>
            ...
            <td style="width:25%;">Hull material: <br><br>
    ...
    <p class="p2" style='text-align: justify'>
        1. That the ship has been inspected in accordance with the requirements of Regulation 11/2 of the PMMRR, 1997
        &nbsp;&nbsp;&nbsp;&nbsp;and its
        its subsequent amendments, and the relevant international maritime convention. <br>
        2. That the inspection showed that at the time of inspection, the condition of the structure, machinery and
        equipments &nbsp;&nbsp;&nbsp;&nbsp;as
        define in the above regulation was satisfactory and the ship complied with the requirements of the PMMRR,
        &nbsp;&nbsp;&nbsp;&nbsp;1997 and
