...
@section('content')
                    ...
                    <div class="box" style="display:none;">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                @can('super-admin')
                                    <a href="#mdlAddUser" data-toggle="modal" class="btn btn-primary btn-sm btn-flat clear_txt"
                                        style="margin-top:8px!important;"> NEW USER</a>
                                @endcan
                            </div>
                        </div>
                                    ...
                                    <tbody style="font-family:calibri;font-size:15px;">
                                        @foreach ($User as $item)
                                            <tr>
                                                ...
                                                <td style="width:2%;"><button style="background:#367fa9;"
                                                        class="button btn btn-success btn-sm resetPass btn-flat"
                                                        value="{{ $item->id }}"><i class="fas fa-power-off"
                                                            style="width:10px;"></i></button></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
    ...
    @if (session()->has('reset_message'))
        <script>
            // Display an "info" Toastr notification
            toastr.warning("{{ session('reset_message') }}");
        </script>
    @endif
    <!-- Add this script at the end of your Blade view or in a separate JS file -->
    <script>
